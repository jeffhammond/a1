      ! caladdr version with different calls for fwd usage (shcoord ord pass2)
      ...
      use getneighbors_vars
      implicit none
      integer int3x(0:*),int3y(0:*),int3z(0:*)
      integer :: child,boxaddr,fix,fiy,fiz,px,py,pz
      integer :: fwdstart,fwdonly,fmmpass,int3exist
      integer,dimension(27) :: vcboxaddr
      integer :: dist
      integer,dimension(8), target :: vix = (/-2, 0,-2, 0,-2, 0,-2, 0/)
      integer,dimension(8), target :: viy = (/-2,-2, 0, 0,-2,-2, 0, 0/)
      integer,dimension(8), target :: viz = (/-2,-2,-2,-2, 0, 0, 0, 0/)
      integer,dimension(8), target :: vix5 = (/-1, 0,-1, 0,-1, 0,-1, 0/)
      integer,dimension(8), target :: viy5 = (/-1,-1, 0, 0,-1,-1, 0, 0/)
      integer,dimension(8), target :: viz5 = (/-1,-1,-1,-1, 0, 0, 0, 0/)
      integer,dimension(7), target :: offset = (/8,16,24,32,40,48,56/)
      integer,dimension(7), target :: offset5 = (/1,2,3,4,5,6,7/)
      integer,dimension(:) , pointer :: pvix,pviy,pviz,poffset
      integer,dimension(8) :: vixyz      
      ...
      integer,dimension(27) :: vcboxaddr
      integer :: dist
      integer,dimension(8), target :: vix = (/-2, 2,-2, 2,-2, 2,-2, 2/)
      integer,dimension(8), target :: viy = (/-2,-2, 0, 0,-2,-2, 0, 0/)
      integer,dimension(8), target :: viz = (/-2,-2,-2,-2, 0, 0, 0, 0/)
      integer,dimension(8), target :: vix5 = (/-1, 1,-1, 1,-1, 1,-1, 1/)
      integer,dimension(8), target :: viy5 = (/-1,-1, 0, 0,-1,-1, 0, 0/)
      integer,dimension(8), target :: viz5 = (/-1,-1,-1,-1, 0, 0, 0, 0/)
      integer,dimension(7), target :: offset = (/8,16,24,32,40,48,56/)
      integer,dimension(7), target :: offset5 = (/1,2,3,4,5,6,7/)
      ...
      integer,dimension(27) :: vcboxaddr
      integer :: dist
      integer,dimension(8), target :: vix = (/-2,-2, 0, 0,-2,-2, 0, 0/)
      integer,dimension(8), target :: viy = (/-2, 2,-2, 2,-2, 2,-2, 2/)
      integer,dimension(8), target :: viz = (/-2,-2,-2,-2, 0, 0, 0, 0/)
      integer,dimension(8), target :: vix5 = (/-1,-1, 0, 0,-1,-1, 0, 0/)
      integer,dimension(8), target :: viy5 = (/-1, 1,-1, 1,-1, 1,-1, 1/)
      integer,dimension(8), target :: viz5 = (/-1,-1,-1,-1, 0, 0, 0, 0/)
      integer,dimension(7), target :: offset = (/8,16,24,32,40,48,56/)
      integer,dimension(7), target :: offset5 = (/1,2,3,4,5,6,7/)
      integer,dimension(:) , pointer :: pvix,pviy,pviz,poffset
      ...
      integer :: dist
      integer,dimension(8), target :: vix = (/-2,-2, 0, 0,-2,-2, 0, 0/)
      integer,dimension(8), target :: viy = (/-2,-2,-2,-2, 0, 0, 0, 0/)
      integer,dimension(8), target :: viz = (/-2, 2,-2, 2,-2, 2,-2, 2/)
      integer,dimension(8), target :: vix5 = (/-1,-1, 0, 0,-1,-1, 0, 0/)
      integer,dimension(8), target :: viy5 = (/-1,-1,-1,-1, 0, 0, 0, 0/)
      integer,dimension(8), target :: viz5 = (/-1, 1,-1, 1,-1, 1,-1, 1/)
      integer,dimension(7), target :: offset = (/8,16,24,32,40,48,56/)
      integer,dimension(7), target :: offset5 = (/1,2,3,4,5,6,7/)
      integer,dimension(:) , pointer :: pvix,pviy,pviz,poffset
      integer,dimension(8) :: vixyz  
      ...
      integer,dimension(27) :: vcboxaddr
      integer :: dist
      integer,dimension(8), target :: vix = (/-2,-2,-2,-2, 0, 0, 0, 0/)
      integer,dimension(8), target :: viy = (/-2, 2,-2, 2,-2, 2,-2, 2/)
      integer,dimension(8), target :: viz = (/-2,-2, 2, 2,-2,-2, 2, 2/)
      integer,dimension(8), target :: vix5 = (/-1,-1,-1,-1, 0, 0, 0, 0/)
      integer,dimension(8), target :: viy5 = (/-1, 1,-1, 1,-1, 1,-1, 1/)
      integer,dimension(8), target :: viz5 = (/-1,-1, 1, 1,-1,-1, 1, 1/)
      integer,dimension(7), target :: offset = (/8,16,24,32,40,48,56/)
      integer,dimension(7), target :: offset5 = (/1,2,3,4,5,6,7/)
      ...
      integer :: dist
      integer,dimension(8), target :: vix = (/-2,-2, 0, 0,-2,-2, 0, 0/)
      integer,dimension(8), target :: viy = (/-2, 0,-2, 0,-2, 0,-2, 0/)
      integer,dimension(8), target :: viz = (/-2,-2,-2,-2, 0, 0, 0, 0/)
      integer,dimension(8), target :: vix5 = (/-1,-1, 0, 0,-1,-1, 0, 0/)
      integer,dimension(8), target :: viy5 = (/-1, 0,-1, 0,-1, 0,-1, 0/)
      integer,dimension(8), target :: viz5 = (/-1,-1,-1,-1, 0, 0, 0, 0/)
      integer,dimension(7), target :: offset = (/8,16,24,32,40,48,56/)
      integer,dimension(7), target :: offset5 = (/1,2,3,4,5,6,7/)
      integer,dimension(:) , pointer :: pvix,pviy,pviz,poffset
	...
	case(2)
      ...
      integer,dimension(8), target :: vix = (/-2,-2, 0, 0,-2,-2, 0, 0/)
      integer,dimension(8), target :: viy = (/-2,-2,-2,-2, 0, 0, 0, 0/)
      integer,dimension(8), target :: viz = (/-2, 0,-2, 0,-2, 0,-2, 0/)
      integer,dimension(8), target :: vix5 = (/-1,-1, 0, 0,-1,-1, 0, 0/)
      integer,dimension(8), target :: viy5 = (/-1,-1,-1,-1, 0, 0, 0, 0/)
      integer,dimension(8), target :: viz5 = (/-1, 0,-1, 0,-1, 0,-1, 0/)
      integer,dimension(7), target :: offset = (/8,16,24,32,40,48,56/)
      integer,dimension(7), target :: offset5 = (/1,2,3,4,5,6,7/)
      integer,dimension(:) , pointer :: pvix,pviy,pviz,poffset
      integer,dimension(8) :: vixyz  
      ...
      integer,dimension(8), target :: vix = (/-2, 2,-2, 2,-2, 2,-2, 2/)
      integer,dimension(8), target :: viy = (/-2,-2,-2,-2, 0, 0, 0, 0/)
      integer,dimension(8), target :: viz = (/-2,-2, 0, 0,-2,-2, 0, 0/)
      integer,dimension(8), target :: vix5 = (/-1, 1,-1, 1,-1, 1,-1, 1/)
      integer,dimension(8), target :: viy5 = (/-1,-1,-1,-1, 0, 0, 0, 0/)
      integer,dimension(8), target :: viz5 = (/-1,-1, 0, 0,-1,-1, 0, 0/)
      integer,dimension(7), target :: offset = (/8,16,24,32,40,48,56/)
      integer,dimension(7), target :: offset5 = (/1,2,3,4,5,6,7/)
      integer,dimension(:) , pointer :: pvix,pviy,pviz,poffset
      integer,dimension(8) :: vixyz  

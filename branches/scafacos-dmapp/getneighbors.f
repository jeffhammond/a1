      subroutine getneighbors(int3x,int3y,int3z,vedge,casejump,boxaddr, &
                 px,py,pz,ix,iy,iz,child,fwdstart,vcboxaddr,dist,fwdonly, &
                 fmmpass,int3exist)
      ...
      use getneighbors_vars, only:fvedge
      implicit none
      integer int3x(0:*),int3y(0:*),int3z(0:*)
      integer :: child !position of child 1-8
      integer :: boxaddr !box adresse centerbox
      integer :: ix,iy,iz !boxaddr 1D index
      integer :: px,py,pz !parent box 1D index
      integer :: fwdstart !first boxnumber larger than boxaddr
      integer :: sboxaddr !short addr max 8,64,512,4096 
      integer :: eix,eiy,eiz !edge ix,iy,iz temps
      integer :: fix,fiy,fiz !child box temps
      integer,dimension(27) :: vcboxaddr ! vector of neighborbox adresses
      integer :: dist !1D distance from neighborbox to centerbox: entry getdist, input:
      integer :: fwdonly ! full (27) neighbor calculation or righthandside only
      integer :: fmmpass ! pass2 fmmpass =1, pass5 fmmpass=2
      integer :: int3exist ! 1= int3x,y,z available and allocated, 2= int3x,y,z not available and not allocated
      integer,dimension(0:*) :: casejump !(0:8) (0:64) (0:512) (0:4096) entry array to find correct case select
      integer, dimension(0:*) :: vedge !corresponding edge

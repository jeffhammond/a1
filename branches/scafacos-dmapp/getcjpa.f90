...
integer,pointer :: gn_nbits
integer, dimension(:),pointer :: gn_bitpos,gn_mbitpos

contains
subroutine getneighborsinit(nbits,bitpos,mbitpos)
	implicit none
	integer,target :: nbits
	integer, dimension(0:),target :: bitpos,mbitpos
...
subroutine getcjpinit(cjpsize)
	...
	implicit none
	integer :: cjpsize ! should be 8,64,512,4096
...
subroutine getcjp(casejump)
	implicit none
	integer, dimension(0:*) :: casejump ! must have same size as casejump(0)+1 starting from zero (0..8) (0..64) (0..512) (0..4096) casejump(0) stores casejump size
...
subroutine getcjp512(casejump)
      ! getcjp -> getcasejump
      implicit none
      integer, dimension(0:512) :: casejump

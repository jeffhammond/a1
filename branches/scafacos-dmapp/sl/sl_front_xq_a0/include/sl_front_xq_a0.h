...
/*#define front_xq_a0_SL_DATA2*/                  /* scr */
...
/*#define front_xq_a0_SL_DATA3*/                  /* addr */
...
/* if no special datatype for (intern) weight ... */
 ...
 /* ... use the double */
# define front_xq_a0_sl_weight_type_c             double      /* sl_macro */
# undef front_xq_a0_sl_weight_type_mpi
# define front_xq_a0_sl_weight_type_mpi           MPI_DOUBLE  /* sl_macro */
# undef front_xq_a0_sl_weight_size_mpi
# define front_xq_a0_sl_weight_size_mpi           1           /* sl_macro */
# undef front_xq_a0_sl_weight_type_fmt
# define front_xq_a0_sl_weight_type_fmt           "f"         /* sl_macro */
#else
  /* ... use the given one and check whether an mpi-type is present and required */
# ifdef SL_USE_MPI
...
#  define front_xq_a0_sl_key_val_srand(_s_)                 sl_srand(_s_)                                        /* sl_macro */
#  define front_xq_a0_sl_key_val_rand()                     ((front_xq_a0_sl_key_pure_type_c) sl_rand())                     /* sl_macro */
#  define front_xq_a0_sl_key_val_rand_minmax(_min_, _max_)  ((front_xq_a0_sl_key_pure_type_c) sl_rand_minmax(_min_, _max_))  /* sl_macro */
# endif
#endif
...
#   define front_xq_a0_FLECKS_GUARD  /* sl_macro */
#  endif
# endif
#endif
...
typedef front_xq_a0_slint_t (*front_xq_a0_binning_exec_f)(struct front_xq_a0__binning_t *bm, front_xq_a0_bin_t *bin, double *counts, double *weights);
typedef front_xq_a0_slint_t (*front_xq_a0_binning_refine_f)(struct front_xq_a0__binning_t *bm, front_xq_a0_bin_t *bin, front_xq_a0_slint_t k, double *counts, double *weights, front_xq_a0_splitter_t *sp, front_xq_a0_slint_t s, front_xq_a0_bin_t *new_bin);
typedef front_xq_a0_slint_t (*front_xq_a0_binning_hit_f)(struct front_xq_a0__binning_t *bm, front_xq_a0_bin_t *bin, front_xq_a0_slint_t k, double *counts, front_xq_a0_splitter_t *sp, front_xq_a0_slint_t s);
typedef front_xq_a0_slint_t (*front_xq_a0_binning_finalize_f)(struct front_xq_a0__binning_t *bm, front_xq_a0_bin_t *bin, double dcw, front_xq_a0_slint_t lc_min, front_xq_a0_slint_t lc_max, double *lcw, front_xq_a0_splitter_t *sp, front_xq_a0_slint_t s);
typedef front_xq_a0_slint_t (*front_xq_a0_binning_post_f)(struct front_xq_a0__binning_t *bm);

#ifdef SL_DEPRECATED
/* sl_type front_xq_a0_binning_exec_pre_old_f front_xq_a0_binning_exec_post_old_f front_xq_a0_binning_refinable_old_f front_xq_a0_binning_refine_old_f */
typedef front_xq_a0_slint_t (*front_xq_a0_binning_exec_pre_old_f)(struct front_xq_a0__binning_t *bm);
typedef front_xq_a0_slint_t (*front_xq_a0_binning_exec_post_old_f)(struct front_xq_a0__binning_t *bm);
typedef front_xq_a0_slint_t (*front_xq_a0_binning_refinable_old_f)(struct front_xq_a0__binning_t *bm);
typedef front_xq_a0_slint_t (*front_xq_a0_binning_refine_old_f)(struct front_xq_a0__binning_t *bm, front_xq_a0_bin_t *bin, front_xq_a0_slint_t k, double *counts, front_xq_a0_bin_t *new_bin);
#endif
...
#ifdef SL_DEPRECATED
  front_xq_a0_binning_exec_pre_old_f exec_pre_old;
  front_xq_a0_binning_exec_post_old_f exec_post_old;
  front_xq_a0_binning_refinable_old_f refinable_old;
  front_xq_a0_binning_refine_old_f refine_old;
#endif
...
#ifdef elem_weight
  front_xq_a0_slint_t doweights, weight_factor;
#endif
...
/* sl_macro front_xq_a0_WEIGHT_FACTOR */
#ifdef elem_weight
# define front_xq_a0_WEIGHT_FACTOR  2
#else
# define front_xq_a0_WEIGHT_FACTOR  1
#endif


/* sl_macro front_xq_a0_get1d front_xq_a0_get2d front_xq_a0_get3d front_xq_a0_get4d */
#define front_xq_a0_get1d(x0)                           (x0)
#define front_xq_a0_get2d(x1, d0, x0)                  ((x0) + (d0) *  (x1))
#define front_xq_a0_get3d(x2, d1, x1, d0, x0)          ((x0) + (d0) * ((x1) + (d1) *  (x2)))
#define front_xq_a0_get4d(x3, d2, x2, d1, x1, d0, x0)  ((x0) + (d0) * ((x1) + (d1) * ((x2) + (d2) * (x3))))


/* sl_macro front_xq_a0_lb_bin_count front_xq_a0_lb_bin_weight */
#define front_xq_a0_lb_bin_count(_lb_, _b_, _j_)    ((_lb_)->bins[(_b_) * (_lb_)->nelements + _j_].s.size)
#ifdef elem_weight
# define front_xq_a0_lb_bin_weight(_lb_, _b_, _j_)  ((_lb_)->bins[(_b_) * (_lb_)->nelements + _j_].weight)
#else
# define front_xq_a0_lb_bin_weight(_lb_, _b_, _j_)  0
#endif

/* sl_macro front_xq_a0_lb_bin_counts front_xq_a0_lb_bin_weights */
#ifdef elem_weight
# define front_xq_a0_lb_bin_counts(_lb_, _b_, _j_, _k_)   ((_lb_)->bin_cws + front_xq_a0_get4d((_lb_)->bcws[_b_], (_lb_)->weight_factor, 0, (_lb_)->nelements, _j_, (_lb_)->bm->nbins, _k_))
# define front_xq_a0_lb_bin_weights(_lb_, _b_, _j_, _k_)  ((_lb_)->bin_cws + front_xq_a0_get4d((_lb_)->bcws[_b_], (_lb_)->weight_factor, 1, (_lb_)->nelements, _j_, (_lb_)->bm->nbins, _k_))
#else
# define front_xq_a0_lb_bin_counts(_lb_, _b_, _j_, _k_)   ((_lb_)->bin_cws + front_xq_a0_get4d((_lb_)->bcws[_b_], 1, 0, (_lb_)->nelements, _j_, (_lb_)->bm->nbins, _k_))
# define front_xq_a0_lb_bin_weights(_lb_, _b_, _j_, _k_)  NULL
#endif

/* sl_macro front_xq_a0_lb_counts front_xq_a0_lb_weights */
#ifdef elem_weight
# define front_xq_a0_lb_counts(_lb_, _b_, _k_)   ((_lb_)->cws + front_xq_a0_get3d((_lb_)->bcws[_b_], (_lb_)->weight_factor, 0, (_lb_)->bm->nbins, (_k_)))
# define front_xq_a0_lb_weights(_lb_, _b_, _k_)  ((_lb_)->cws + front_xq_a0_get3d((_lb_)->bcws[_b_], (_lb_)->weight_factor, 1, (_lb_)->bm->nbins, (_k_)))
#else
# define front_xq_a0_lb_counts(_lb_, _b_, _k_)   ((_lb_)->cws + front_xq_a0_get3d((_lb_)->bcws[_b_], 1, 0, (_lb_)->bm->nbins, (_k_)))
# define front_xq_a0_lb_weights(_lb_, _b_, _k_)  NULL
#endif

/* sl_macro front_xq_a0_gb_counts front_xq_a0_gb_weights */
#ifdef elem_weight
# define front_xq_a0_gb_counts(_gb_, _b_, _k_)   ((_gb_)->cws + front_xq_a0_get3d((_gb_)->bcws[_b_], (_gb_)->lb.weight_factor, 0, (_gb_)->bm->nbins, (_k_)))
# define front_xq_a0_gb_weights(_gb_, _b_, _k_)  ((_gb_)->cws + front_xq_a0_get3d((_gb_)->bcws[_b_], (_gb_)->lb.weight_factor, 1, (_gb_)->bm->nbins, (_k_)))
#else
# define front_xq_a0_gb_counts(_gb_, _b_, _k_)   ((_gb_)->cws + front_xq_a0_get3d((_gb_)->bcws[_b_], 1, 0, (_gb_)->bm->nbins, (_k_)))
# define front_xq_a0_gb_weights(_gb_, _b_, _k_)  NULL
#endif
...
# define SL_FRAC2INT(p)   ((front_xq_a0_slint_t) ((p) * -SL_FRACRES))
...
extern FILE *front_xq_a0_sl_notice_fstream;
extern FILE *front_xq_a0_sl_error_fstream;
extern FILE *front_xq_a0_sl_debug_fstream;

/* src/include/sl_rti_intern.h */
extern rti front_xq_a0_rti_env;

/* src/core/front_xq_a0_sort_radix_ip.c */
extern front_xq_a0_slint_t front_xq_a0_sa_ip_threshold;

/* src/core_mpi/mpi_common.c */
#ifdef SL_USE_MPI
extern MPI_Datatype front_xq_a0_int_mpi_datatype;
extern MPI_Datatype front_xq_a0_key_mpi_datatype;
extern MPI_Datatype front_xq_a0_pkey_mpi_datatype;
extern MPI_Datatype front_xq_a0_pwkey_mpi_datatype;
extern MPI_Datatype front_xq_a0_index_mpi_datatype;
extern MPI_Datatype front_xq_a0_weight_mpi_datatype;
extern MPI_Datatype front_xq_a0_data_mpi_datatype[];
#endif
#ifdef SL_USE_MPI
extern int front_xq_a0_sl_mpi_rank;
#endif

/* src/core_mpi/mpi_elements.c */
extern void *front_xq_a0_me_sendrecv_replace_mem;
extern front_xq_a0_slint_t front_xq_a0_me_sendrecv_replace_memsize;
extern front_xq_a0_slint_t front_xq_a0_me_sendrecv_replace_mpi_maxsize;

/* src/core_mpi/front_xq_a0_mpi_select_exact_generic.c */
extern front_xq_a0_slint_t front_xq_a0_mseg_rounds;
extern int front_xq_a0_mseg_root;
extern double front_xq_a0_mseg_border_update_propagation;
extern front_xq_a0_slint_t front_xq_a0_mseg_border_update_full;
extern front_xq_a0_slint_t front_xq_a0_mseg_binnings;

/* src/core_mpi/front_xq_a0_mpi_sort_partition.c */
extern double front_xq_a0_msp_t[];
extern front_xq_a0_slint_t front_xq_a0_msp_sync;
...
/* src/core/binning.c */
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_create)(front_xq_a0_local_bins_t *lb, front_xq_a0_slint_t max_nbins, front_xq_a0_slint_t max_nbinnings, front_xq_a0_elements_t *s, front_xq_a0_slint_t nelements, front_xq_a0_slint_t doweights, front_xq_a0_binning_t *bm);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_exec_reset)(front_xq_a0_local_bins_t *lb);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_exec)(front_xq_a0_local_bins_t *lb, front_xq_a0_slint_t b);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_finalize)(front_xq_a0_local_bins_t *lb, front_xq_a0_slint_t b, front_xq_a0_slweight_t dcw, front_xq_a0_slint_t lc_min, front_xq_a0_slint_t lc_max, front_xq_a0_slweight_t *lcw, front_xq_a0_splitter_t *sp, front_xq_a0_slint_t s);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_exec)(front_xq_a0_binning_t *bm, front_xq_a0_bin_t *bin, front_xq_a0_slweight_t *counts, front_xq_a0_slweight_t *weights);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_refine)(front_xq_a0_binning_t *bm, front_xq_a0_bin_t *bin, front_xq_a0_slint_t k, front_xq_a0_slweight_t *counts, front_xq_a0_slweight_t *weights, front_xq_a0_splitter_t *sp, front_xq_a0_slint_t s, front_xq_a0_bin_t *new_bin);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_hit)(front_xq_a0_binning_t *bm, front_xq_a0_bin_t *bin, front_xq_a0_slint_t k, front_xq_a0_slweight_t *counts, front_xq_a0_splitter_t *sp, front_xq_a0_slint_t s);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_finalize)(front_xq_a0_binning_t *bm, front_xq_a0_bin_t *bin, front_xq_a0_slweight_t dcw, front_xq_a0_slint_t lc_min, front_xq_a0_slint_t lc_max, front_xq_a0_slweight_t *lcw, front_xq_a0_splitter_t *sp, front_xq_a0_slint_t s);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_post)(front_xq_a0_binning_t *bm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_exec_pre_old)(front_xq_a0_binning_t *bm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_exec_post_old)(front_xq_a0_binning_t *bm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_refinable_old)(front_xq_a0_binning_t *bm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_binning_radix_refine_old)(front_xq_a0_binning_t *bm, front_xq_a0_bin_t *bin, front_xq_a0_slint_t k, front_xq_a0_slweight_t *counts, front_xq_a0_bin_t *new_bin);

/* src/core/checksum_crc.c */
unsigned short SL_PROTO(front_xq_a0_elements_crc16)(front_xq_a0_elements_t *s, front_xq_a0_slint n, front_xq_a0_slint keys, front_xq_a0_slint data);
unsigned int SL_PROTO(front_xq_a0_elements_crc32)(front_xq_a0_elements_t *s, front_xq_a0_slint n, front_xq_a0_slint keys, front_xq_a0_slint data);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elements_alloc2)(front_xq_a0_elements_t *s, front_xq_a0_slint_t nelements, front_xq_a0_slint_t keys, front_xq_a0_slint_t indices, front_xq_a0_slint_t data, front_xq_a0_slint_t weights);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elements_alloc_old)(front_xq_a0_elements_t *s, front_xq_a0_slint_t nelements, front_xq_a0_slint_t keys, front_xq_a0_slint_t data);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elements_alloc_from_block2)(front_xq_a0_elements_t *s, void *block, front_xq_a0_slint_t blocksize, front_xq_a0_slint_t alignment, front_xq_a0_slint_t nmax, front_xq_a0_slint_t keys, front_xq_a0_slint_t indices, front_xq_a0_slint_t data, front_xq_a0_slint_t weights);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elements_alloc_from_block)(front_xq_a0_elements_t *s, void *block, front_xq_a0_slint_t blocksize, front_xq_a0_slint_t alignment, front_xq_a0_slint_t nmax);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elements_init_keys)(front_xq_a0_elements_t *s, front_xq_a0_slint_t dtype, front_xq_a0_slint_t _min, front_xq_a0_slint_t _max);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elements_init_keys2)(front_xq_a0_elements_t *s, front_xq_a0_slint_t dtype, front_xq_a0_slkey_pure_t key_min, front_xq_a0_slkey_pure_t key_max);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elements_init_keys_from_file)(front_xq_a0_elements_t *s, front_xq_a0_slint_t data, char *filename, front_xq_a0_slint_t from, front_xq_a0_slint_t to, front_xq_a0_slint_t const_bytes_per_line);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elements_save_keys_to_file)(front_xq_a0_elements_t *s, char *filename);
...
front_xq_a0_slint SL_PROTO(front_xq_a0_key2class_equal)(front_xq_a0_slkey_t *k, front_xq_a0_slint i, void *ci);
front_xq_a0_slint SL_PROTO(front_xq_a0_key2class_split)(front_xq_a0_slkey_t *k, front_xq_a0_slint i, void *ci);
front_xq_a0_slint SL_PROTO(front_xq_a0_key2class_split_keys)(front_xq_a0_slkey_t *k, front_xq_a0_slint i, void *ci);
front_xq_a0_slint SL_PROTO(front_xq_a0_key2class_random)(front_xq_a0_slkey_t *k, front_xq_a0_slint i, void *ci);
front_xq_a0_slint SL_PROTO(front_xq_a0_key2class_ci_nocounts)(front_xq_a0_slkey_t *k, front_xq_a0_slint i, void *ci);
front_xq_a0_slint SL_PROTO(front_xq_a0_key2class_ci)(front_xq_a0_slkey_t *k, front_xq_a0_slint i, void *ci);
...
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_sbin_x0_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_sbin_0x_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_sbin_01_x)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_sbin_01)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *t);

/* src/core/merge2_basic_shyb.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_shyb_x0_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_shyb_0x_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_shyb_01_x)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_shyb_01)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *t);

/* src/core/merge2_basic_sseq.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_sseq_x0_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_sseq_0x_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_sseq_01_x)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_sseq_01)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *t);

/* src/core/merge2_basic_straight.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_straight_x0_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_straight_0x_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_straight_01_x)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_straight_x_0_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_straight_X0_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx, front_xq_a0_elements_t *t);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_straight_0X_1)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx, front_xq_a0_elements_t *t);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_straight_01_X)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx, front_xq_a0_elements_t *t);
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_basic_straight_X0_1u)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx, front_xq_a0_elements_t *t);

/* src/core/front_xq_a0_merge2_compo_hula.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_compo_hula)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *xs);

/* src/core/front_xq_a0_merge2_compo_tridgell.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_merge2_compo_tridgell)(front_xq_a0_elements_t *s0, front_xq_a0_elements_t *s1, front_xq_a0_elements_t *sx);

/* src/core/front_xq_a0_merge2_memory_adaptive.c */
...
/* src/core/search.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_sequential_lt)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_sequential_le)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_sequential_gt)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_sequential_ge)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_binary_lt)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_binary_le)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_binary_gt)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_binary_ge)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_binary_lt2)(front_xq_a0_elements_t *s, front_xq_a0_slkey_pure_t k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_binary_le2)(front_xq_a0_elements_t *s, front_xq_a0_slkey_pure_t k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_binary_gt2)(front_xq_a0_elements_t *s, front_xq_a0_slkey_pure_t k);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_binary_ge2)(front_xq_a0_elements_t *s, front_xq_a0_slkey_pure_t k);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_sl_search_binary_lt_bmask)(front_xq_a0_elements_t *s, front_xq_a0_slkey_pure_t k, front_xq_a0_slkey_pure_t bmask);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_hybrid_lt)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k, front_xq_a0_slint t);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_hybrid_le)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k, front_xq_a0_slint t);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_hybrid_gt)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k, front_xq_a0_slint t);
front_xq_a0_slint SL_PROTO(front_xq_a0_sl_search_hybrid_ge)(front_xq_a0_elements_t *s, front_xq_a0_slkey_t *k, front_xq_a0_slint t);
...
long long SL_PROTO(front_xq_a0_sl_random64)();
double SL_PROTO(front_xq_a0_sl_nrandom)();
double SL_PROTO(front_xq_a0_sl_urandom)();
...
/* src/core/sl_elem.c */
front_xq_a0_slint_t SL_PROTO(front_xq_a0_elem_set_data)(front_xq_a0_elements_t *e, ...);
...
/* src/core/front_xq_a0_sort_counting.c */
...
front_xq_a0_slint SL_PROTO(front_xq_a0_sort_permute_forward)(front_xq_a0_elements_t *s, front_xq_a0_elements_t *sx, front_xq_a0_slint *perm, front_xq_a0_slint offset, front_xq_a0_slint mask_bit);
front_xq_a0_slint SL_PROTO(front_xq_a0_sort_permute_backward)(front_xq_a0_elements_t *s, front_xq_a0_elements_t *sx, front_xq_a0_slint *perm, front_xq_a0_slint offset, front_xq_a0_slint mask_bit);

/* src/core/front_xq_a0_sort_quick.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_sort_quick)(front_xq_a0_elements_t *s, front_xq_a0_elements_t *xs);

/* src/core/front_xq_a0_sort_radix.c */
...
/* src/core/front_xq_a0_sort_radix_1bit.c */
...
/* src/core/front_xq_a0_sort_radix_af.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_sort_radix_af)(front_xq_a0_elements_t *s, front_xq_a0_elements_t *sx, front_xq_a0_slint rhigh, front_xq_a0_slint rlow, front_xq_a0_slint rwidth);

/* src/core/front_xq_a0_sort_radix_db.c */
...
/* src/core/front_xq_a0_sort_radix_iter.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_sort_radix_iter)(front_xq_a0_elements_t *s, front_xq_a0_elements_t *sx, front_xq_a0_slint presorted, front_xq_a0_slint rhigh, front_xq_a0_slint rlow, front_xq_a0_slint rwidth);

/* src/core/front_xq_a0_sort_radix_ma.c */
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_binning_create)(front_xq_a0_global_bins_t *gb, front_xq_a0_slint_t max_nbins, front_xq_a0_slint_t max_nbinnings, front_xq_a0_elements_t *s, front_xq_a0_slint_t nelements, front_xq_a0_slint_t doweights, front_xq_a0_binning_t *bm, int size, int rank, MPI_Comm comm);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_binning_exec_reset)(front_xq_a0_global_bins_t *gb, int size, int rank, MPI_Comm comm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_binning_exec_local)(front_xq_a0_global_bins_t *gb, front_xq_a0_slint_t b, int size, int rank, MPI_Comm comm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_binning_exec_global)(front_xq_a0_global_bins_t *gb, front_xq_a0_slint_t root, int size, int rank, MPI_Comm comm);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_binning_finalize)(front_xq_a0_global_bins_t *gb, front_xq_a0_slint_t b, front_xq_a0_slweight_t dcw, front_xq_a0_slint_t lc_min, front_xq_a0_slint_t lc_max, front_xq_a0_slweight_t *lcw, front_xq_a0_splitter_t *sp, front_xq_a0_slint_t s, int size, int rank, MPI_Comm comm);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_get_grid)(front_xq_a0_slint_t ndims, front_xq_a0_slint_t *dims, front_xq_a0_slint_t *pos, int size, int rank, MPI_Comm comm);
...
/* src/core_mpi/mpi_elements.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_mpi_elements_init_keys_from_file)(front_xq_a0_elements_t *s, char *filename, front_xq_a0_slint from, front_xq_a0_slint to, front_xq_a0_slint const_bytes_per_line, front_xq_a0_slint root, int size, int rank, MPI_Comm comm);
...
unsigned short SL_PROTO(front_xq_a0_mpi_cs16)(front_xq_a0_elements_t *s, front_xq_a0_slint n, front_xq_a0_slint keys, front_xq_a0_slint data, int size, int rank, MPI_Comm comm);
unsigned int SL_PROTO(front_xq_a0_mpi_cs32)(front_xq_a0_elements_t *s, front_xq_a0_slint n, front_xq_a0_slint keys, front_xq_a0_slint data, int size, int rank, MPI_Comm comm);
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_elements_alltoallv_ip)(front_xq_a0_elements_t *sbuf, front_xq_a0_elements_t *sx, int *scounts, int *sdispls, int *rcounts, int *rdispls, int size, int rank, MPI_Comm comm);
...
/* src/core_mpi/front_xq_a0_mpi_find_exact.c */
...
/* src/core_mpi/front_xq_a0_mpi_linsplit.c */
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_linsplit)(MPI_Comm comm_in, front_xq_a0_slkey_pure_t *keys_in, MPI_Comm *comms_out, front_xq_a0_slint_t *parity, int size, int rank, MPI_Comm comm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_linsplit2)(MPI_Comm comm_in, front_xq_a0_slkey_pure_t *keys_in, MPI_Comm *comms_out, front_xq_a0_slint_t *parity, int size, int rank, MPI_Comm comm);

/* src/core_mpi/front_xq_a0_mpi_merge2.c */
...
/* src/core_mpi/front_xq_a0_mpi_mergek.c */
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_mergek_presort_radix)(front_xq_a0_mergek_t *mk, front_xq_a0_slint_t rmerge, front_xq_a0_elements_t *s_in, MPI_Comm *comms_in, front_xq_a0_slint_t parity_in, front_xq_a0_elements_t *s_out, MPI_Comm *comms_out, front_xq_a0_slint_t *parity_out, int size, int rank, MPI_Comm comm);

/* src/core_mpi/front_xq_a0_mpi_partition_exact_generic.c */
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_partition_exact_generic2)(front_xq_a0_elements_t *s, front_xq_a0_partcond_t *pcond, front_xq_a0_binning_t *bm, int *scounts, int *rcounts, int size, int rank, MPI_Comm comm);

/* src/core_mpi/front_xq_a0_mpi_partition_exact_radix.c */
...
/* src/core_mpi/front_xq_a0_mpi_partition_joink.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_mpi_partition_joink)(front_xq_a0_elements_t *s, front_xq_a0_slint *sizes, int size, int rank, MPI_Comm comm);

/* src/core_mpi/front_xq_a0_mpi_partition_radix2.c */
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_partition_radix2)(front_xq_a0_elements_t *s, front_xq_a0_partcond2_t *pc, front_xq_a0_slint_t rhigh, front_xq_a0_slint_t rlow, front_xq_a0_slint_t rwidth, int *scounts, int *sdispls, int size, int rank, MPI_Comm comm);

/* src/core_mpi/front_xq_a0_mpi_partition_radix_old.c */
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_partition_radix_old)(front_xq_a0_elements_t *s, front_xq_a0_partcond2_t *pc, front_xq_a0_slint_t rhigh, front_xq_a0_slint_t rlow, front_xq_a0_slint_t rwidth, int *scounts, int *sdispls, int size, int rank, MPI_Comm comm);
...
/* src/core_mpi/front_xq_a0_mpi_rebalance.c */
...
/* src/core_mpi/front_xq_a0_mpi_redistribute_exact_generic.c */
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_redistribute_exact_generic)(front_xq_a0_elements_t *sin, front_xq_a0_elements_t *sout, front_xq_a0_partcond_t *pcond, front_xq_a0_parttype_t *ptype, front_xq_a0_binning_t *bm, int *rcounts, int size, int rank, MPI_Comm comm);
...
/* src/core_mpi/front_xq_a0_mpi_select_exact_radix.c */
...
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_select_exact_radix_fixed)(front_xq_a0_elements_t *s, front_xq_a0_slint_t nelements, front_xq_a0_slint_t nparts, front_xq_a0_partcond_t *pconds, front_xq_a0_slint_t rhigh, front_xq_a0_slint_t rlow, front_xq_a0_slint_t rwidth, int *sdispls, int size, int rank, MPI_Comm comm);
...
/* src/core_mpi/front_xq_a0_mpi_select_qs.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_mpi_select_qs)(front_xq_a0_elements_t *s, front_xq_a0_slint n, front_xq_a0_slint *iths, front_xq_a0_pivot_func pi, front_xq_a0_slint threshold, front_xq_a0_slkey_pure_t *e, int size, int rank, MPI_Comm comm);

/* src/core_mpi/front_xq_a0_mpi_select_radix2.c */
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_select_radix2)(front_xq_a0_elements_t *s, front_xq_a0_slint_t nparts, front_xq_a0_partcond_t *pconds, front_xq_a0_slint_t rhigh, front_xq_a0_slint_t rlow, front_xq_a0_slint_t rwidth, int *sdispls, int size, int rank, MPI_Comm comm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_select_stats2)(front_xq_a0_elements_t *s, front_xq_a0_slint_t nparts, int *sdispls, int size, int rank, MPI_Comm comm);
front_xq_a0_slint_t SL_PROTO(front_xq_a0_mpi_select_radix_pg2)(front_xq_a0_elements_t *s, front_xq_a0_slint_t nparts, front_xq_a0_partcond_t *pcond, MPI_Comm pcomm, MPI_Comm mcomm, front_xq_a0_slint_t rhigh, front_xq_a0_slint_t rlow, front_xq_a0_slint_t rwidth, int *sdispls, int size, int rank, MPI_Comm comm);
...
/* src/core_mpi/front_xq_a0_mpi_sort_merge.c */
...
/* src/core_mpi/front_xq_a0_mpi_splitk.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_mpi_splitk)(front_xq_a0_elements_t *s, front_xq_a0_k2c_func k2c, void *ci, front_xq_a0_elements_t *sx, front_xq_a0_elements_t *sa, front_xq_a0_slint *nne, front_xq_a0_slint *nue, int size, int rank, MPI_Comm comm);

/* src/core_mpi/front_xq_a0_mpi_splitk_dummy.c */
front_xq_a0_slint SL_PROTO(front_xq_a0_mpi_splitk_dummy)(front_xq_a0_elements_t *s, front_xq_a0_k2c_func k2c, void *ci, front_xq_a0_elements_t *sx, front_xq_a0_slint *send_stats, int size, int rank, MPI_Comm comm);

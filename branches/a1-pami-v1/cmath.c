					    ...
					    size_t                  c0)
{
  ...
  register double f0  FP_REG(0) = 0.0;
  register double f1  FP_REG(1) = 0.0;
  register double f2  FP_REG(2) = 0.0;
  register double f3  FP_REG(3) = 0.0;
  register double f4  FP_REG(4) = 0.0;
  f2 = ainfo->scale;

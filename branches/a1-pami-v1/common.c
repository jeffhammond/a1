...
{    
  ...
  rget.rdma.local.mr      = src_mr;
  rget.rdma.local.offset  = (size_t)srcbuf - (size_t)src_base;
  rget.rdma.remote.mr     = dst_mr;
  rget.rdma.remote.offset = (size_t)dstbuf - (size_t)dst_base;    
